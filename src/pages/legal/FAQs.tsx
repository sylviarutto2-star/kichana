...
const FAQS: { q: string; a: string }[] = [
  ...
  { q: "How does payment work?", a: "You pay a 10% deposit on M-Pesa to confirm the booking — that's Kichana's fee for running the platform. The remaining 90% is paid directly to the stylist on completion. We never store your M-Pesa PIN." },
  ...
  { q: "I'm a stylist — how much does Kichana cost me?", a: "Nothing out of your pocket. The customer's 10% deposit is Kichana's fee — you receive the 90% balance directly from the customer at the appointment. No monthly fees, no setup costs. Free service additions, free profile, free portfolio hosting." },

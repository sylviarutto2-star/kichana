...
// Note: imagery curated to feature Black women, African stylists, and authentic
// Nairobi salon work. Swap freely as real users post their own portfolios.
...
export const demoStylists: (Stylist & { profile: { full_name: string; avatar_url: string | null }; from_kes: number })[] = [
  {
    ...
    hero_image_url: img("photo-1620331311520-246422fd82f9"),
    ...
    profile: { full_name: "Amani Wanjiru", avatar_url: img("photo-1531123414780-f74242c2b052") },
    from_kes: 2500,
  },
  {
    ...
    hero_image_url: img("photo-1581252584837-9f0b1d3bf82c"),
    ...
    created_at: new Date().toISOString(),
    profile: { full_name: "Nia Mwangi", avatar_url: img("photo-1614283233556-f35b0c801ef1") },
    from_kes: 3500,
  },
  {
    id: "demo-3", profile_id: "demo", display_name: "Lulu Wigs",
    bio: "Wig installs, frontals, and HD lace. Custom colour. Kilimani salon.",
    hero_image_url: img("photo-1580894732444-8ecded7900cd"),
    ...
    created_at: new Date().toISOString(),
    profile: { full_name: "Lulu Achieng", avatar_url: img("photo-1531123414780-f74242c2b052") },
    from_kes: 4500,
  },
  {
    id: "demo-4", profile_id: "demo", display_name: "Locs By Imani",
    bio: "Sisterlocks, microlocs, retwists. Patient, gentle, perfect partings.",
    hero_image_url: img("photo-1601412436009-d964bd02edbc"),
    ...
    featured_until: null, commission_rate: 0.10, loyalty_tier: "silver",
    created_at: new Date().toISOString(),
    profile: { full_name: "Imani Otieno", avatar_url: img("photo-1614283233556-f35b0c801ef1") },
    from_kes: 2800,
  },
  {
    ...
    featured_until: null, commission_rate: 0.10, loyalty_tier: "gold",
    created_at: new Date().toISOString(),
    profile: { full_name: "Glow Studio", avatar_url: img("photo-1604654894537-1c6e6d04b2c8") },
    from_kes: 1500,
  },
  {
    id: "demo-6", profile_id: "demo", display_name: "Kev Cuts",
    bio: "Fades, line-ups, beard sculpting. South B barbershop.",
    hero_image_url: img("photo-1599351431202-1e0f0137899a"),
    ...
    featured_until: null, commission_rate: 0.10, loyalty_tier: "silver",
    created_at: new Date().toISOString(),
    profile: { full_name: "Kevin Ouma", avatar_url: img("photo-1593104547489-5cfb3839a3b5") },
    from_kes: 800,
  },
];
...
export const demoFeed: (FeedPost & { author_name: string; stylist_name?: string; avatar_url?: string })[] = [
  { id: "demo-f1", author_id: "demo", stylist_id: "demo-1", booking_id: null,
    image_url: img("photo-1620331311520-246422fd82f9"),
    ...
    avatar_url: img("photo-1531123414780-f74242c2b052"),
  },
  { id: "demo-f2", author_id: "demo", stylist_id: "demo-3", booking_id: null,
    image_url: img("photo-1580894732444-8ecded7900cd"),
    ...
    avatar_url: img("photo-1614283233556-f35b0c801ef1"),
  },
  { id: "demo-f3", author_id: "demo", stylist_id: "demo-4", booking_id: null,
    image_url: img("photo-1601412436009-d964bd02edbc"),
  ...
  { id: "demo-f4", author_id: "demo", stylist_id: "demo-2", booking_id: null,
    image_url: img("photo-1581252584837-9f0b1d3bf82c"),
  ...
  { id: "demo-f5", author_id: "demo", stylist_id: "demo-5", booking_id: null,
    ...
    avatar_url: img("photo-1604654894537-1c6e6d04b2c8"),
  },
];
